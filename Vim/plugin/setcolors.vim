...
" Press key:
"   F3                next scheme
"   Shift-F3          previous scheme
"   Ctrl-F3            random scheme
...
let s:mycolors = ['torte', 'candy', 'guardian2', 'molokai']  " colorscheme names that we use to set color
let s:moje = 'torte candy guardian2 molokai'
...
function! s:SetColors(args)
  ...
  elseif a:args == 'my'
    let s:mycolors = split(s:moje)
    echo 'Zaladowano moje kolorki'
  elseif a:args == 'now'
    call s:HourColor()
  else
...
nnoremap <C-F3> :call NextColor(0)<CR>
